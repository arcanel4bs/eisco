  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl mb-8 text-center text-[#4A0404] font-montserrat">¿Quiénes somos?</h1>
        ...
        <h2 className="text-2xl flex text-[#4A0404] mb-6 font-montserrat font-semibold">Misión</h2>
        <p className="text-lg text-gray-600 mb-8 font-roboto">
        ...
        <h2 className="text-2xl flex text-[#4A0404] mb-6 font-montserrat font-semibold">Visión</h2>
        <p className="text-lg text-gray-600 mb-8 font-roboto">
