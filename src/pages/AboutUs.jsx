  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl flex justify-center text-gray-800 mb-8 font-montserrat">¿Quiénes somos?</h1>
        ...
        <h2 className="text-2xl flex text-gray-800 mb-6 font-montserrat">Misión</h2>
        <p className="text-lg text-gray-600 mb-8 font-roboto">
        ...
        <h2 className="text-2xl flex text-gray-800 mb-6 font-montserrat">Visión</h2>
        <p className="text-lg text-gray-600 mb-8 font-roboto">
